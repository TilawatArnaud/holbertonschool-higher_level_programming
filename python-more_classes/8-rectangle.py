...
"""Defines a class Rectangle with width, height,
 instance counter, and string representations."""
...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Return the rectangle with the greater area, or rect 1 if equal"""
    ...
    def square(cls, size=0):
        """Return a new Rectangle instance with equal width height and size"""
